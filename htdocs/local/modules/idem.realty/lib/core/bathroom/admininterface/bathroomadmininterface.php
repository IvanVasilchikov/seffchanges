 ...
 * {@inheritdoc}
 */
class BathroomAdminInterface extends DAdminInterface
{
    ...
    {
        return array(
            '\Idem\Realty\Core\Bathroom\AdminInterface\BathroomListHelper' => array(
                'BUTTONS' => array(
                    'LIST_CREATE_NEW' => array(
                        'TEXT' => "Создать вариант санузла",
                    ),
                )
            ),
            '\Idem\Realty\Core\Bathroom\AdminInterface\BathroomEditHelper' => array(
                'BUTTONS' => array(
                    'ADD_ELEMENT' => array(
                        'TEXT' => "Создать вариант санузла",
                    ),
                    'DELETE_ELEMENT' => array(
                        'TEXT' => "Удалить вариант санузла",
                    )
                )
            )
        );
