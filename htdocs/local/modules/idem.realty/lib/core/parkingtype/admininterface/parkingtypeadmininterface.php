 ...
 * {@inheritdoc}
 */
class ParkingtypeAdminInterface extends DAdminInterface
{
    ...
    {
        return array(
            '\Idem\Realty\Core\Parkingtype\AdminInterface\ParkingtypeListHelper' => array(
                'BUTTONS' => array(
                    'LIST_CREATE_NEW' => array(
                        'TEXT' => "Создать Тип парковки",
                    ),
                )
            ),
            '\Idem\Realty\Core\Parkingtype\AdminInterface\ParkingtypeEditHelper' => array(
                'BUTTONS' => array(
                    'ADD_ELEMENT' => array(
                        'TEXT' => "Создать Тип парковки",
                    ),
                    'DELETE_ELEMENT' => array(
                        'TEXT' => "Удалить Тип парковки",
                    )
                )
            )
        );
