 ...
 * {@inheritdoc}
 */
class FlattypeAdminInterface extends DAdminInterface
{
    ...
    {
        return array(
            '\Idem\Realty\Core\Flattype\AdminInterface\FlattypeListHelper' => array(
                'BUTTONS' => array(
                    'LIST_CREATE_NEW' => array(
                        'TEXT' => "Создать тип квартиры",
                    ),
                )
            ),
            '\Idem\Realty\Core\Flattype\AdminInterface\FlattypeEditHelper' => array(
                'BUTTONS' => array(
                    'ADD_ELEMENT' => array(
                        'TEXT' => "Создать тип квартиры",
                    ),
                    'DELETE_ELEMENT' => array(
                        'TEXT' => "Удалить тип квартиры",
                    )
                )
            )
        );
