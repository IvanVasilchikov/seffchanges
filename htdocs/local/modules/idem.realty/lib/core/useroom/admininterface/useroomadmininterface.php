 ...
 * {@inheritdoc}
 */
class UseroomAdminInterface extends DAdminInterface
{
    ...
    {
        return array(
            '\Idem\Realty\Core\Useroom\AdminInterface\UseroomListHelper' => array(
                'BUTTONS' => array(
                    'LIST_CREATE_NEW' => array(
                        'TEXT' => "Создать Назначение помещения",
                    ),
                )
            ),
            '\Idem\Realty\Core\Useroom\AdminInterface\UseroomEditHelper' => array(
                'BUTTONS' => array(
                    'ADD_ELEMENT' => array(
                        'TEXT' => "Создать Назначение помещения",
                    ),
                    'DELETE_ELEMENT' => array(
                        'TEXT' => "Удалить Назначение помещения",
                    )
                )
            )
        );
