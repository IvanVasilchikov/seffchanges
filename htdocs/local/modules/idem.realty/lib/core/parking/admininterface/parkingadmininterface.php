 ...
 * {@inheritdoc}
 */
class ParkingAdminInterface extends DAdminInterface
{
    ...
    {
        return array(
            '\Idem\Realty\Core\Parking\AdminInterface\ParkingListHelper' => array(
                'BUTTONS' => array(
                    'LIST_CREATE_NEW' => array(
                        'TEXT' => "Создать С парковкой",
                    ),
                )
            ),
            '\Idem\Realty\Core\Parking\AdminInterface\ParkingEditHelper' => array(
                'BUTTONS' => array(
                    'ADD_ELEMENT' => array(
                        'TEXT' => "Создать С парковкой",
                    ),
                    'DELETE_ELEMENT' => array(
                        'TEXT' => "Удалить С парковкой",
                    )
                )
            )
        );
