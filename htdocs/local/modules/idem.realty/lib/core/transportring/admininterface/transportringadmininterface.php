 ...
 * {@inheritdoc}
 */
class TransportringAdminInterface extends DAdminInterface
{
    ...
    {
        return array(
            '\Idem\Realty\Core\Transportring\AdminInterface\TransportringListHelper' => array(
                'BUTTONS' => array(
                    'LIST_CREATE_NEW' => array(
                        'TEXT' => "Создать транспортное кольцо",
                    ),
                )
            ),
            '\Idem\Realty\Core\Transportring\AdminInterface\TransportringEditHelper' => array(
                'BUTTONS' => array(
                    'ADD_ELEMENT' => array(
                        'TEXT' => "Создать транспортное кольцо",
                    ),
                    'DELETE_ELEMENT' => array(
                        'TEXT' => "Удалить транспортное кольцо",
                    )
                )
            )
        );
