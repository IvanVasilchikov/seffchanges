 ...
 * {@inheritdoc}
 */
class RealtyclassAdminInterface extends DAdminInterface
{
    ...
    {
        return array(
            '\Idem\Realty\Core\Realtyclass\AdminInterface\RealtyclassListHelper' => array(
                'BUTTONS' => array(
                    'LIST_CREATE_NEW' => array(
                        'TEXT' => "Создать класс недвижимости",
                    ),
                )
            ),
            '\Idem\Realty\Core\Realtyclass\AdminInterface\RealtyclassEditHelper' => array(
                'BUTTONS' => array(
                    'ADD_ELEMENT' => array(
                        'TEXT' => "Создать класс недвижимости",
                    ),
                    'DELETE_ELEMENT' => array(
                        'TEXT' => "Удалить класс недвижимости",
                    )
                )
            )
        );
