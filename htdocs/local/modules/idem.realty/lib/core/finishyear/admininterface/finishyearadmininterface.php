 ...
 * {@inheritdoc}
 */
class FinishyearAdminInterface extends DAdminInterface
{
    ...
    {
        return array(
            '\Idem\Realty\Core\Finishyear\AdminInterface\FinishyearListHelper' => array(
                'BUTTONS' => array(
                    'LIST_CREATE_NEW' => array(
                        'TEXT' => "Создать Готовность дома",
                    ),
                )
            ),
            '\Idem\Realty\Core\Finishyear\AdminInterface\FinishyearEditHelper' => array(
                'BUTTONS' => array(
                    'ADD_ELEMENT' => array(
                        'TEXT' => "Создать Готовность дома",
                    ),
                    'DELETE_ELEMENT' => array(
                        'TEXT' => "Удалить Готовность дома",
                    )
                )
            )
        );
