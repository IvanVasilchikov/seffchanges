 ...
 * {@inheritdoc}
 */
class WaterAdminInterface extends DAdminInterface
{
    ...
    {
        return array(
            '\Idem\Realty\Core\Water\AdminInterface\WaterListHelper' => array(
                'BUTTONS' => array(
                    'LIST_CREATE_NEW' => array(
                        'TEXT' => "Создать У водоема",
                    ),
                )
            ),
            '\Idem\Realty\Core\Water\AdminInterface\WaterEditHelper' => array(
                'BUTTONS' => array(
                    'ADD_ELEMENT' => array(
                        'TEXT' => "Создать У водоема",
                    ),
                    'DELETE_ELEMENT' => array(
                        'TEXT' => "Удалить У водоема",
                    )
                )
            )
        );
