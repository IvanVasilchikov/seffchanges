 ...
 * {@inheritdoc}
 */
class DealtypeAdminInterface extends DAdminInterface
{
    ...
    {
        return array(
            '\Idem\Realty\Core\Dealtype\AdminInterface\DealtypeListHelper' => array(
                'BUTTONS' => array(
                    'LIST_CREATE_NEW' => array(
                        'TEXT' => "Создать тип сделки",
                    ),
                )
            ),
            '\Idem\Realty\Core\Dealtype\AdminInterface\DealtypeEditHelper' => array(
                'BUTTONS' => array(
                    'ADD_ELEMENT' => array(
                        'TEXT' => "Создать тип сделки",
                    ),
                    'DELETE_ELEMENT' => array(
                        'TEXT' => "Удалить тип сделки",
                    )
                )
            )
        );
