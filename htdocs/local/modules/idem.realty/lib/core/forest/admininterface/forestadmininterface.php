 ...
 * {@inheritdoc}
 */
class ForestAdminInterface extends DAdminInterface
{
    ...
    {
        return array(
            '\Idem\Realty\Core\Forest\AdminInterface\ForestListHelper' => array(
                'BUTTONS' => array(
                    'LIST_CREATE_NEW' => array(
                        'TEXT' => "Создать Лес рядом",
                    ),
                )
            ),
            '\Idem\Realty\Core\Forest\AdminInterface\ForestEditHelper' => array(
                'BUTTONS' => array(
                    'ADD_ELEMENT' => array(
                        'TEXT' => "Создать Лес рядом",
                    ),
                    'DELETE_ELEMENT' => array(
                        'TEXT' => "Удалить Лес рядом",
                    )
                )
            )
        );
