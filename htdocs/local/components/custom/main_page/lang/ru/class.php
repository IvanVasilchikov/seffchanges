<?
$MESS ['helpBest'] =  "нужна помощь в подборе лучших предложений?";
$MESS ['getPrez'] = "получить презентацию";
$MESS ['livTown'] = "Городская";
$MESS ['liveOffTown'] = "Загородная";
$MESS ['name'] = "Имя";
$MESS ['phone'] = "Телефон";
$MESS ['message'] = "Сообщение";
$MESS ['gerPod'] = "Получить подборку";
$MESS ['prez'] = "получить презентацию";
$MESS ['zakazPod'] =  "заказать подбор брокеру";
